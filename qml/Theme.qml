...
QtObject {
    ...
    property color backgroundColor:         theme === "light" ? "#f4f4f4" : "#1B8EF2"   // Off-white for light theme, softer dark for dark theme
    ...
    property color buttonColor:             theme === "light" ? "#E0E0E0" : "#424242"   // Softer grey for light theme, lighter grey for dark theme
